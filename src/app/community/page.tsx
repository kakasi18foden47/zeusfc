    ...
    <div className="bg-[#0a0a0a] min-h-screen">
      ...
      <main className="flex flex-1 items-center justify-center min-h-[60vh]">
        <div className="text-center space-y-4">
          <p className="text-[10px] tracking-[0.5em] text-[#555] uppercase">Community</p>
          <h1 className="font-cinzel text-4xl font-black tracking-[0.2em] text-white">COMMUNITY</h1>
